...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-12 w-full items-center justify-between whitespace-nowrap rounded-md border-2 border-muted bg-transparent px-3 py-2 text-sm shadow-sm ring-offset-white placeholder:text-stone-500 focus:outline-none focus:ring-1 focus:ring-stone-950 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 dark:border-muted dark:ring-offset-primary dark:placeholder:text-muted-foreground dark:focus:ring-primary-foreground",
      className
    )}
    {...props}
  >
